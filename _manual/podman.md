...
- **Compose.** `podman compose` hands your file to a compose provider. If the host has none, the stack list says "podman compose is not available on this host … Install podman-compose or the Docker Compose plugin."
